...
architecture behav of greyScale is 
    ...
    "greyScale,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.232000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=25,HLS_SYN_FF=3411,HLS_SYN_LUT=4845}";
    ...
    signal pixelInput_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal pixelInput_ce0 : STD_LOGIC;
    signal pixelInput_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal pixelOutput_address0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_7_fu_203_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_7_reg_411 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal sum2_fu_207_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal sum4_fu_226_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                    sum2_cast_reg_417(9 downto 0) <= sum2_cast_fu_212_p1(9 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                    sum4_cast_reg_442(9 downto 0) <= sum4_cast_fu_231_p1(9 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    sum2_cast_reg_417(31 downto 10) <= "0000000000000000000000";
    sum4_cast_reg_442(31 downto 10) <= "0000000000000000000000";
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            pixelInput_address0 <= sum4_cast_fu_231_p1(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            pixelInput_address0 <= sum2_cast_fu_212_p1(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            pixelInput_address0 <= pixelStart_1_fu_84(9 - 1 downto 0);
        else 
            pixelInput_address0 <= "XXXXXXXXX";
        end if; 
    end process;
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state31)) then 
            pixelOutput_address0 <= sum4_cast_reg_442(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state30)) then 
            pixelOutput_address0 <= sum2_cast_reg_417(9 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state29)) then 
            pixelOutput_address0 <= pixelStart_1_fu_84(9 - 1 downto 0);
        else 
            pixelOutput_address0 <= "XXXXXXXXX";
        end if; 
    end process;
    ...
    sum2_fu_207_p2 <= std_logic_vector(unsigned(ap_const_lv10_1) + unsigned(tmp_7_reg_411));
    sum4_cast_fu_231_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum4_fu_226_p2),32));
    sum4_fu_226_p2 <= std_logic_vector(unsigned(ap_const_lv10_2) + unsigned(tmp_7_reg_411));
    ...
    tmp_7_fu_203_p1 <= pixelStart_1_fu_84(10 - 1 downto 0);
