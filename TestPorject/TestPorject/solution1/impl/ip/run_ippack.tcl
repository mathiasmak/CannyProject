...
set Library     "hls"
set IPName      "greyScale"
set Version     "1.1"
set DisplayName "Greyscale"
set Revision    "1412051632"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "pixelInput {base_address 2048 range 2048} pixelOutput {base_address 4096 range 2048}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
set enable_xo_gen 0
set kernel_files {C:/Users/mathi/Desktop/Kandidat/Embedded/Project/testings/TestPorject/dataflow.c}
if {$enable_xo_gen} {
