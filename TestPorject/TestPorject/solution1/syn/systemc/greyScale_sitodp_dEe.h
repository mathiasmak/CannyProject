...
#ifndef __greyScale_sitodp_dEe__HH__
#define __greyScale_sitodp_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(greyScale_sitodp_dEe) {
    ...
    SC_CTOR(greyScale_sitodp_dEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
